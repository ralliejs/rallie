...
export function mixinBlockState<T extends BaseBlock<unknown>, U>(
  block: T,
...
export function mixinBlockEvents<T extends BaseBlock<unknown>>(
  block: T,
...
export function mixinBlockMethods<T extends CreatedBlock<unknown>>(
  block: T,
