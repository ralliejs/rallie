...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      { attrs: { id: "app" } },
      [
        _c("img", { attrs: { alt: "Vue logo", src: __webpack_require__(/*! ./logo.png */ "./web/vueModule/logo.png") } }),
        _vm._v(" "),
        _c("HelloWorld", { attrs: { text: "" } })
      ],
      1
    )
  ])
...
window.globalBus.createSocket('vueSocket', []).then(function (_ref) {
